    ...
    translation: {
      ...
      problem: {
        ...
        cards: {
          ...
          bD: "Most people don't have access to accurate price forecasts.",
          cT: "Poor buying decisions",
          cD: "People often buy at the highest prices and spend too much money.",
          dT: "Small business risks",
          dD: "Shop owners struggle with inventory due to uncertainty.",
          eT: "Regional differences",
          eD: "Prices vary by region and are very difficult to keep track of.",
          fT: "Low data visibility",
          fD: "Historical data exists, but it is not being used effectively.",
        },
      ...
      solution: {
        ...
        provideBText: "A humane conclusion describing the action.",
    ...
    translation: {
      ...
      problem: {
        ...
        cards: {
          ...
          bD: "У многих отсутствует точный прогнозный анализ.",
          cT: "Плохие решения",
          cD: "Они покупают по самой высокой цене и переплачивают.",
          dT: "Риски бизнеса",
          dD: "Сложно управлять запасами при неопределённости.",
          eT: "Разница по регионам",
          eD: "Цены всегда сильно различаются в разных регионах.",
      ...
      how: {
        ...
        step1Text: "Категория, продукт, регион, горизонт.",
        step2: "Анализ",
        step2Text: "Бэкенд грузит историю, считает и прогноз.",
        step3: "Результат",
  ...
  uz: {
    translation: {
      ...
      benefits: {
        ...
        coreA: "Pul tejash",
        coreAText: "Arzon paytda olish, qimmat joylardan qochish.",
